<template>
    <basic-container>
      <avue-crud :option="room.option" :page.sync="page" :data="data" @on-load="onLoad" @search-change="searchChange"
  ...
  import { pageRoom, pageRecord,handlePlayRecord,reqJoinRecordList } from "@/api/plane/index"
