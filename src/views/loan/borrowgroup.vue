...
import {pageBorrowGroupByUserId} from "@/api/loan/loan";
...
export default {
  ...
  methods: {
    onLoad() {
      this.loading = true;
      pageBorrowGroupByUserId(this.query).then(res => {
    ...
    searchChange(params, done) {
      ...
      if (params.returnDate) this.query.date = dayjs(params.returnDate).format('YYYY-MM-DD');
