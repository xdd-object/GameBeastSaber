  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="封号原因" align="center">
          <template slot-scope="scope">{{scope.row.deleteMark}}</template>
        </el-table-column>
        <el-table-column label="锁定原因" align="center">
          <template slot-scope="scope">{{scope.row.lockMark}}</template>
        </el-table-column>
        <el-table-column label="操作" width="120" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="unsealUser(scope.$index, scope.row)">解封
            </el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        getForbiddenUserList(this.listQuery).then(response => {
